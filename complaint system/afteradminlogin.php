...
<html>
  ...
  <script>
	...
	<style>
    .bg-dark-warning {
        background-color: #283593; /* You can adjust the color code to the specific darker shade you prefer */
    }
</style>
  ...
  <nav class="navbar-nav navbar-expand-sm bg-dark-warning" style="margin:0px;padding:0px;">
...
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:20px 2px 0px 20px;color:white"></i>
		...
		<img src="ad.png" style="border-radius:15%;margin-left:25%;float:left" width="90px" height="80px">
		<h3 style="float:left; cursor:pointer; margin:10px 2px 0px 20px; color: #ffffff;">CS | Admin</h3>
